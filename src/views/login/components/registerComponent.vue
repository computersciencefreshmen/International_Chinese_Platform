...
<template>
  <div
    v-if="step.initial"
    class="flex flex-col items-center justify-center w-2/3"
  >
    <div class="flex items-center mt-4">
      ...
      >
        <img class="w-10 h-10" src="@/assets/icon/student.png" alt="我是学生" />
      </optionsCp>
      <optionsCp
        text="我是老师"
        @click="handleIsRegisterActive"
      ...
      >
        <img class="w-12 h-12" src="@/assets/icon/teacher.png" alt="我是老师" />
      </optionsCp>
    </div>
  ...
  <div v-if="isRegisterActive === '我是学生' && step.stepStudent.stepOne">
    1
  </div>
  <div v-if="isRegisterActive === '我是老师' && step.stepTeacher.stepOne">
    2
  </div>
</template>
<style></style>
