...
const classList = ref([
  {
    ...
    name: '吴同学',
    topic: '中国的历史',
    time: '2025/2/21 08:00-09:00'
  },
  {
    id: 2,
    name: '李同学',
    topic: '中国的瓷器',
    time: '2025/2/23 08:00-09:00'
  },
  {
    id: 3,
    name: '王同学',
    topic: '中国的文化',
    time: '2025/2/24 08:00-09:00'
  }
]) // 初始课程列表数据

//未对接课程列表
const unconnectedClassList = ref([
  {
    id: 1,
    name: '张同学',
    topic: '中国的地理',
    time: '2025/5/25 08:00-09:00'
  },
  {
    id: 2,
    name: '赵同学',
    topic: '中国的科技',
    time: '2025/5/26 08:00-09:00'
  },
  {
    id: 3,
    name: '钱同学',
    topic: '中国的艺术',
    time: '2025/5/27 08:00-09:00'
  }
]) // 未对接课程列表数据
...
const handleTabClick = (tab) => {
  ...
  if (tab === '已对接') {
    ...
    classList.value = unconnectedClassList.value // 未对接的课程列表
  }
}
</script>
      ...
      <div class="flex-1 bg-white rounded-lg px-4 overflow-y-auto scrollBar">
        ...
        >
          <div class="flex items-center gap-8">
            ...
            <p class="text-gray-500">课程话题：{{ item.topic }}</p>
            <p class="text-gray-500">预约时间:{{ item.time }}</p>
          </div>
