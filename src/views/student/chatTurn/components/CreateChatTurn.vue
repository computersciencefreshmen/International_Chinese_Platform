...
const handleChatTurnSubmit = () => {
  ...
  if (keyword1.value && keyword2.value && keyword3.value) {
    ...
    chatTurn.value = [
      '足球在操场中央滚动，孩子们在奔跑。',
      '操场上，一场激烈的足球比赛正在进行。球员们在绿茵场上奔跑，汗水在阳光下闪闪发光。他们追逐着足球，每一次传球、射门都充满活力，展现出体育的魅力。',
      '在阳光明媚的下午，学校的操场变成了欢乐的海洋。一群热爱足球的少年们在这里尽情奔跑，他们穿着色彩鲜艳的球衣，脸上洋溢着青春的气息。足球在他们脚下灵活地滚动，时而划出一道优美的弧线，时而被精准地传到队友脚下。观众们围在操场边，为他们加油助威，呐喊声、欢呼声此起彼伏。这就是体育的力量，它让每一个参与者都充满激情，也让每一个观众都能感受到运动的魅力。'
    ]
    // 清空输入框
    // keyword1.value = ''
    // keyword2.value = ''
