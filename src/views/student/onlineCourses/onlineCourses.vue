...
// 导入图片
import transportImg from '@/assets/student/onlineCourses/transport.jpg'
import doctorImg from '@/assets/student/onlineCourses/doctor.png'
import springImg from '@/assets/student/onlineCourses/spring.png'
import traditionalOperaImg from '@/assets/student/onlineCourses/traditionalOpera.png'
import travelImg from '@/assets/student/onlineCourses/travel.png'
import firecrackersImg from '@/assets/student/onlineCourses/firecrackers.png'
import grammer1Img from '@/assets/student/onlineCourses/grammer1.jpeg'
import tenseImg from '@/assets/student/onlineCourses/tense.jpg'
import lieFlatImg from '@/assets/student/onlineCourses/lieFlat.png'
...
//定义口语课程列表
const spokenCourseList = ref([
  {
    id: 1,
    title: '交通对话学习',
    description: '当你来到中国，需要搭乘交通工具的时候应该如何表述呢？',
    imgUrl: transportImg
  },
  //医生看病
  {
  ...
  //春节对话学习
  {
    id: 3,
    title: '春节对话学习',
    description: '当你来到中国，春节对话学习应该如何表述呢？',
    imgUrl: springImg
  },
  //戏曲对话学习
  {
    id: 4,
    title: '戏曲对话学习',
    description: '当你来到中国，戏曲对话学习应该如何表述呢？',
    imgUrl: traditionalOperaImg
  },
  //旅行
  {
    id: 5,
    title: '旅行对话学习',
    description: '当你来到中国，旅行对话学习应该如何表述呢？',
    imgUrl: travelImg
  },
  //烟花爆竹
  {
    id: 6,
    title: '烟花爆竹对话学习',
    description: '当你来到中国，烟花爆竹对话学习应该如何表述呢？',
    imgUrl: firecrackersImg
  }
])

//定义语法课程列表
const grammarCourseList = ref([
  //中文语法学习
  {
    id: 0,
    title: '中文语法学习',
    description: '当你来到中国，中文语法学习应该如何表述呢？',
    imgUrl: grammer1Img
  },
  //医生看病
  {
    id: 2,
    title: '中文时态学习',
    description: '当你来到中国，中文时态学习应该如何表述呢？',
    imgUrl: tenseImg
  },
  //躺平用中文怎么表达
  {
...
const handleSearch = (e) => {
  ...
  // title.value = e
  // getCourseList()
  spokenCourseList.value = [
    {
      id: 1,
      title: '交通对话学习',
      description: '当你来到中国，需要搭乘交通工具的时候应该如何表述呢？',
      imgUrl: 'http://sv1tl8pf6.hn-bkt.clouddn.com/urgent.png'
    }
  ]
}
</script>
    ...
    <div ref="container" class="bg-blue-50 rounded-lg p-4 flex flex-col">
      ...
      <nav class="flex items-center mb-4">
        ...
        <MyButton
          ...
          >语法</MyButton
        >
        <MySearchBox class="w-2/5" @search="handleSearch"></MySearchBox>
      </nav>
      <!-- 网课列表，网格布局 -->
      <main class="overflow-auto flex-1 scrollBar px-4">
        <Transition :name="direction" mode="out-in">
          ...
          >
            <!-- 口语课程 -->
            <div
              v-for="item in spokenCourseList"
              :key="item.id"
              class="bg-white shadow-lg rounded-lg p-4 cursor-pointe transition-all duration-300 ease-in-out"
            >
              <img
          ...
          >
            <!-- 语法课程 -->
            <div
              v-for="item in grammarCourseList"
              :key="item.id"
              class="bg-white shadow-lg rounded-lg p-4 cursor-pointer transition-all duration-300 ease-in-out"
            >
              <img
                class="w-full h-32 object-cover rounded-lg"
                :src="item.imgUrl"
